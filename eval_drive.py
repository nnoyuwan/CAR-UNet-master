...
desired_size = 592
for i in test_files:
    im = io.imread(testing_images_loc + i)
    label = io.imread(testing_label_loc + i.split('_')[0] + '_manual1.png')
...
model = CARUNet(input_size=(desired_size, desired_size, 3), start_neurons=16, keep_prob=1, block_size=1, lr=1e-3)
weight = "Drive/Model/CARUNet.h5"
